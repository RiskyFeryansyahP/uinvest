...
func (m *MockRepositoryAuthentication) GetDataUser(ctx context.Context, input model.LoginInput) (*model.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepositoryAuthentication) CreateDataUser(ctx context.Context, input model.RegisterInput) (*model.User, error) {
	m.ctrl.T.Helper()
